...
import { K as KinstaLayout } from "./KinstaLayout-417c4ed2.mjs";
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(ssrRenderComponent(KinstaLayout, _attrs, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<article class="mx-auto mt-10 flex justify-center max-w-5xl border-b-2"${_scopeId}><img src="/images/kinsta-logo.png" class="w-80 h-80 rounded-xl mx-auto py-5" alt=""${_scopeId}>`);
            ...
            _push2(`<div class="text-left flex flex-col pt-5 pb-10 px-10"${_scopeId}><h1 class="text-xl font-semibold mb-10"${_scopeId}>${ssrInterpolate(__props.article.title)}</h1><p${_scopeId}>${ssrInterpolate(__props.article.body)}</p></div></article>`);
          } else {
            return [
